        ...
        <div class="col-md-6 col-sm-6">
            ...
            <div class="options">
                ...
                <div class="social box">
                    ...
                    <a class="twitter"
                       href="{{route('share',['platform'=>'twitter','table'=>'customer','content_id'=>$customer[0]->id])}}"><i
                            class="fab fa-2x fa-twitter-square"></i></a>&nbsp;
                    <a class="whatsapp"
                       href="{{route('share',['platform'=>'whatsapp','table'=>'customer','content_id'=>$customer[0]->id])}}"><i
                            class="fab fa-2x fa-whatsapp"></i></a>&nbsp;
                    <a class="linkedin"
                       href="{{route('share',['platform'=>'linkedin','table'=>'customer','content_id'=>$customer[0]->id])}}"><i
