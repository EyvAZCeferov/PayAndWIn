...
<div>
                    ...
                    <div class="modal-body">
                        <div class="input-group">
                            <input type="text" class="form-control control-search"
                                placeholder="@lang('static.standart.topPanel.searchPlaceholder')"
                                name="keyword"
                                required
                                />
                            <button class="button_search" type="submit">@lang('static.standart.topPanel.search')</button>
                        </div><!-- /input-group -->
    ...
    <div class="wrappage">
                    ...
                    <div class="inner-topbar box">
                        <div class="float-left">
                            <p><i class="fa fa-envelope"></i> @lang('static.standart.topPanel.contactMail')
                                <span><a href="mailto:{{ settings('email') }}"
                                        class="acc"> {{ settings('email') }}</a></span></p>
                        </div>
                    ...
                    <div class="box">
                        ...
                        <div class="logo">
                            <a href="{{route('index')}}" title="{{ settings('projectName') }} Logo">
                                <img src="data:image/png;base64,{{get_image(settings('logo'),'commons/logos')}}" width="60"
                                    alt="{{ settings('projectName') }} Logo">
                            </a></div>
                        ...
                        <nav class="mega-menu">
                            ...
                            <ul class="nav navbar-nav" id="navbar">
                                            ...
                                            @foreach($customers as $customer)
                                                <li class="level2">
                                                    ...
                                                    <ul class="menu-level-2">
                                                        <li class="level3"><a href="{{ route('products',$customer->id) }}" >@lang('static.menu.products')</a></li>
                                                        <li class="level3"><a href="{{ route('customerCampaigns',$customer->id) }}" >@lang('static.menu.campaigns')</a></li>
                                                        <li class="level3"><a href="{{ route('customerLocationsBrowse',$customer->id) }}" >@lang('static.menu.shops')</a></li>
                                                    </ul>
                                                </li>
                                            @endforeach
                                        </ul>
                                ...
                                <li class="level1 @yield('contactActive',null)">
                                    ...
                                    title="@lang('static.menu.contact')">
        ...
        <div class="container" id="topSubject">
            <div class="banner-header banner-lbook3 space-30">
                ...
                <div class="text">
                    <h3>@yield('title')</h3>
                    <p><a href="{{route('index')}}" title="@lang('static.menu.index')">@lang('static.menu.index')</a>
                        &nbsp;
                        <i
                            class="fa fa-caret-right"></i>@yield('title')</p>
                </div>
            </div>
        </div>
    ...
    <!-- End container -->
        ...
        <footer id="footer" class="mt-4 align-left">
            <div class="container container-ver2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="social space-30">
                                <a href="{{ settings('twitter_page') }}" title="{{ settings('projectName') }} Twitter"><i
                                        class="fab fa-twitter"></i></a>
                                <a href="{{ settings('facebook_page') }}" title="{{ settings('projectName') }} Facebook"><i
                                        class="fab fa-facebook-f"></i></a>
                                <a href="{{ settings('youtube_page') }}" title="{{ settings('projectName') }} Youtube"><i
                                        class="fab fa-youtube"></i></a>
                                <a href="{{ settings('instagram_page') }}"
                                title="{{ settings('projectName') }} Instagram"><i class="fab fa-instagram"></i></a>
                        ...
                        <div class="col-md-4 col-sm-6">
                            ...
                            <div class="subscribe">
                                <form action="{{ route('emailsender') }}" method="post" accept-charset="utf-8">
                                    ...
                                    <button class="button button1 hover-white" title="@lang('static.form.buttons.submit')"
            ...
            <div class="footer-bottom box">
                <div class="container container-ver2">
                    <div class="box bottom">
                        <p class="float-left">@lang('static.standart.bottomPanel.copyright') {{settings('copyright')}}.
                        </p>
                        <div class="float-right">
                            <ul class="menu-bottom-footer">
                                ...
                                <li><a href="{{route('termofuse')}}"
                                    title="@lang('static.menu.termofuse')">@lang('static.menu.termofuse')</a></li>
                            </ul>
                            <div class="language">
