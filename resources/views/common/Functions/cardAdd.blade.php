                    ...
                    <div class="front">
                        ...
                        <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            <g id="Front">
                                ...
                                <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">@lang('static.page.profile.addCart.columns.nameAndSurname')</text>
                                <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">@lang('static.page.profile.addCart.columns.cardholderName')</text>
                                <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">@lang('static.page.profile.table.columns.expirationDate')</text>
                                <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">@lang('static.page.profile.table.columns.number')</text>
                                <g>
                    ...
                    <div class="back">
                        <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            ...
                            C707.1,246.4,704.4,249.1,701.1,249.1z" />
                                ...
                                <g class="st8">
                                    <text transform="matrix(1 0 0 1 518.083 280.0879)" class="st9 st6 st10">@lang('static.page.profile.addCart.columns.securityCode')</text>
                                </g>
                                <rect x="58.1" y="378.6" class="st11" width="375.5" height="13.5" />
                                <rect x="58.1" y="405.6" class="st11" width="421.7" height="13.5" />
                                <text transform="matrix(1 0 0 1 59.5073 228.6099)" id="svgnameback" class="st12 st13">@lang('static.page.profile.addCart.columns.nameAndSurname')</text>
                            </g>
                        </svg>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('cartadd') }}" >
                    ...
                    <div class="form-container">
                        <div class="field-container">
                            <label for="cardnumber">@lang('static.page.profile.table.columns.number')</label><span id="generatecard">@lang('static.page.profile.addCart.columns.generate')</span>
                            <input id="cardnumber" type="text" name="number" required inputmode="numeric">
                        ...
                        <div class="field-container">
                            ...
                            <input id="expirationdate" type="text" name="expiry" required inputmode="numeric">
                        </div>
                        <div class="field-container">
                            <label for="securitycode">@lang('static.page.profile.addCart.columns.securityCode')</label>
                            <input id="securitycode" type="text" name="cvc" required inputmode="numeric">
                        </div>
                        <div class="field-container">
                            <label for="password">@lang('static.page.profile.addCart.columns.cartPass')</label>
                            <input id="password" required name="password"  maxlength="4" inputmode="numeric" type="text">
                        </div>
...
<script>
    ...
    cardnumber_mask.on("accept", function () {
        ...
        $("#card_type").val(cardnumber_mask.masked.currentMask.cardtype);
